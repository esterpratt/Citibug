<template>
  <div class="home">
    <header>
      <transition name="fade">
        <div
          class="back-img"
          :key="backImg"
          :style="{'background-image': 'url(' + backImgSrc +')'}"
        ></div>
      </transition>
      ...
      <h1>Be a PAL!
        <p>Join the community,
          <br>report issues,
          <br>help solving others
          <br>and make our city
          <br>a better place!
        </p>
    ...
    <section class="container" ref="main">
      <div class="carousel-container" v-for="(issuesObj, idx) in issuesLists" :key="idx">
