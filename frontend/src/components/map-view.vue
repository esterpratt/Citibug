<template>
  <section class="map">
    <GmapMap ref="mapRef" :center="center" :zoom="16" map-type-id="terrain" @click="setCoords">
      <GmapMarker :position="coords" :draggable="isEditable" @dragend="setCoords"/>
    </GmapMap>
    <img class="pan-container" @click="panTo" src="../assets/img/gps.png">
  </section>
</template>
