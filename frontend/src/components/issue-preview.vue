<template>
  <section class="issue-preview" @click="openIssue">
    ...
    <div class="issue-img" :style="'background-image: url(' + issue.newPic + ')'"></div>
    <div class="issue-details">
      <div class="time">reported {{issue.createdAt | relative-time}}</div>
      <h3>{{issue.title}}</h3>
    ...
    <div class="issue-severity" :class="severityStatus">{{severityStatus}}</div>
  </section>
</template>
